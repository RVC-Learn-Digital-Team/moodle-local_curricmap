...
$string['contentmapping_allsections'] = 'All sections';
$string['contentmapping_alltypes'] = 'All module types';
$string['contentmapping_coursesearch'] = 'Find a course by name or ID number';
$string['contentmapping_drill'] = 'Map activities ({$a})';
...
$string['studyresources_label'] = 'Label (optional, defaults to the URL)';
...
$string['studyresources_resource'] = 'Resource';
