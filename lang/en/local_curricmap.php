...
$string['coverage_resources'] = 'Study resources: {$a->resources} ({$a->hiddenresources} hidden)';
...
$string['resetrules:confirm'] = 'Replace the saved course matching rules with the shipped defaults?';
$string['resetrules:done'] = 'Course matching rules reset to the shipped defaults.';
...
$string['settings:matchingrulesreset'] = 'Reset matching rules to the shipped defaults';
