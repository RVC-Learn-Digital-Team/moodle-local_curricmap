...
$string['contentmapping_browse'] = 'More curriculum';
...
$string['coursemapping_browseallyears'] = 'All years';
$string['coursemapping_browseprogrammes'] = 'Programmes';
...
$string['coursemapping_pre2024'] = 'pre 2024 courses';
...
$string['coursemapping_show_matched'] = 'Show: matched ({$a})';
$string['coursemapping_show_skipped'] = 'Show: skipped ({$a})';
$string['coursemapping_show_suggested'] = 'Show: suggested ({$a})';
...
$string['errorresourcesdisabled'] = 'Resource linking is disabled on this site.';
...
$string['resourcesdisabled'] = 'Resource linking is disabled in the Curriculum map general settings.';
...
$string['settings:resourcelinking'] = 'Support resource linking';
$string['settings:resourcelinking_desc'] = 'Off hides every resource surface at once; existing resources are kept, not shown.';
...
$string['status_purge'] = 'Purge';
$string['status_purgeconfirm'] = 'Delete the {$a->name} mirror ({$a->nodes} nodes) and its sync history? Bindings orphan; years still in Sofia reappear on rediscovery.';
$string['status_purged'] = '{$a->name} purged — {$a->nodes} node(s) removed.';
