...
$string['coursemapping_onlyidnumber'] = 'Only courses with idnumber';
...
$string['coursemapping_show_all'] = 'Show: all courses';
$string['coursemapping_show_existing'] = 'Show: already matched';
$string['coursemapping_show_matched'] = 'Show: matched proposals';
$string['coursemapping_show_unmatched'] = 'Show: unmatched';
