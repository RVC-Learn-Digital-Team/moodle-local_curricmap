...
final class derive_test extends \basic_testcase {
    ...
    public static function role_provider(): array {
        return [
            ...
            'module is a strand-equivalent container' => ['U', 'Module', 'year', 'strand'],
            'untyped container at top level is other' => ['U', null, null, 'other'],
            // Sofia ships untyped containers; role() falls back on position.
            'untyped container under a year is a strand' => ['U', null, 'year', 'strand'],
            'untyped container under a strand is a unit' => ['U', null, 'strand', 'unit'],
            'untyped container nests under a unit' => ['U', null, 'unit', 'unit'],
            'unknown subtype falls back on position too' => ['U', 'Widget', 'year', 'strand'],
            'unknown subtype under a strand is a unit' => ['U', 'Widget', 'strand', 'unit'],
            // Named grouping containers, should Sofia ever type them.
            'unit subtype is a unit' => ['U', 'Unit', 'strand', 'unit'],
            'theme subtype is a unit-level grouping' => ['U', 'Theme', 'strand', 'unit'],
            'folder subtype is a unit-level grouping' => ['U', 'Folder', 'strand', 'unit'],
            ...
            'year-level outcome is a strand outcome' => ['O', null, 'year', 'strandoutcome'],
            'session outcome' => ['O', null, 'session', 'sessionoutcome'],
            'nested session outcome' => ['O', null, 'sessionoutcome', 'sessionoutcome'],
            'unit-level outcome is a strand outcome' => ['O', null, 'unit', 'strandoutcome'],
            'outcome under assessment is a session outcome' => ['O', null, 'assessment', 'sessionoutcome'],
